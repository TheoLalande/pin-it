...
import { FaHome, FaSearch, FaUser, FaInfoCircle } from 'react-icons/fa'

const Footer: React.FC = () => {
  return (
    <footer className="fixed bottom-4 left-1/2 transform -translate-x-1/2 bg-white shadow-lg w-3/4 rounded-full">
